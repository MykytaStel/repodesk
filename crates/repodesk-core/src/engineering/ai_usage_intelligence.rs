...
pub fn derive_ai_usage_report(
    ...
    let mut report = AiUsageReport {
        ...
        accepted_change_count: intelligence.decisions.accepted_change_count,
        accepted_change_cost_units: intelligence.decisions.accepted_change_cost_units,
        correction_cost_units: intelligence.decisions.correction_cost_units,
        verification_debt_count: intelligence.decisions.verification_debt_count,
        decision_count: intelligence.decisions.decision_count,
        override_count: intelligence.decisions.override_count,
        context,
        orchestration,
        outcomes,
        signals: Vec::new(),
